...
Pod::Spec.new do |s|
  ...
  s.subspec 'Ali' do |ali|
    ali.source_files = 'PGPay/AliPayDepend/Classes/**/*', 'Pods/AlipaySDK-iOS/AlipaySDK.framework/Headers/*.h'#, 'PGPay/AliPayDepend/Signer/**/*.h', 'PGPay/AliPayDepend/Signer/**/*.m', 'PGPay/AliPayDepend/Signer/**/*.swift'
    ali.dependency 'AlipaySDK-iOS'
    
    #ali.xcconfig = {
    #  'OTHER_LDFLAGS' => '-ObjC', 'HEADER_SEARCH_PATHS' => '$(PROJECT_DIR)/PGPay/AliPayDepend/Signer'
    #}
